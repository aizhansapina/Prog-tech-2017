...
namespace Complex
{
    class Program
    {
        class Complex
        {
            ...
            {
                Complex c = new Complex((a.x * b.y) / gcd(a.y, b.y)  + (b.x * a.y) / gcd(a.y , b.y), (a.y * b.y) / gcd(a.y, b.y));
                return c;
            }
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(sum.x / Complex.gcd(sum.x, sum.y) + " " + sum.y / Complex.gcd(sum.x, sum.y));
